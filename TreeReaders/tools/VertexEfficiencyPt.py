...
leg.SetBorderSize(1)
#leg.SetNColumns(3)
#HistogramNames=["ConvdZPt","SuperdZPt","MixdZPt"]
HistogramNames=["MixdZPt"]
...
for histname,outfile in zip(HistogramNames,OutFileNames):
	...
	multigraph.SetNameTitle("multigraph",";Pt (GeV);Efficiency (%)");
